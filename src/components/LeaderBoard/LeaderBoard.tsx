...
// const getLeaderboard = (players: LeaderBoardEntry[]): LeaderBoardEntry[] => {
//   // Filter out players who haven't played (optional, see discussion below)
...
//   const _leaderboard = useMemo(() => getLeaderboard(players), [players]);
