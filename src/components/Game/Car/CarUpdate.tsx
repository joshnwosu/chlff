...
//     generateAdditionQuestions(level)
//   );
...
//       setQuestions(generateAdditionQuestions(Level.YEAR_1));
//     }
//     if (selectedYear === 2) {
//       setLevel(Level.YEAR_2);
//       setQuestions(generateAdditionQuestions(Level.YEAR_2));
//     }
//     if (selectedYear === 3) {
//       setLevel(Level.YEAR_3);
//       setQuestions(generateAdditionQuestions(Level.YEAR_3));
//     }
//     if (selectedYear === 4) {
//       setLevel(Level.YEAR_4);
//       setQuestions(generateAdditionQuestions(Level.YEAR_4));
//     }
//     if (selectedYear === 5) {
//       setLevel(Level.YEAR_5);
//       setQuestions(generateAdditionQuestions(Level.YEAR_5));
//     }
//     if (selectedYear === 6) {
//       setLevel(Level.YEAR_6);
//       setQuestions(generateAdditionQuestions(Level.YEAR_6));
//     }
