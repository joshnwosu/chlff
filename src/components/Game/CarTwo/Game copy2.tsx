...
const Game = () => {
  ...
  const handleTimeUp = useCallback(() => {
    ...
    console.log("value of time is up :", isTimeUp);
    console.log("value of is game active :", isGameActive);
    console.log("value of replay stage :", replayStage);
  }, [isTimeUp, isGameActive, replayStage]);
  ...
  useEffect(() => {
    if (timer <= 0) {
      ...
      if (correctAnswers >= MIN_CORRECT_ANSWERS) {
        ...
        console.log("setting replay stage to true");

        setReplayStage(true)

        console.log("pass mark" + MIN_CORRECT_ANSWERS);
        console.log("score" + correctAnswers);

      }
      console.log("timer:", timer);
      console.log("isTimeUp (before):", isTimeUp);
      console.log("isGameActive (before):", isGameActive);
      console.log("replaystage (before):", replayStage);
    }
  }, [correctAnswers, handleTimeUp, isGameActive, isTimeUp, replayStage, timer]);

  useEffect(() => {
    if (isTimeUp && !isGameActive) {
      console.log("isTimeUp (updated):", isTimeUp);
      console.log("isGameActive (updated):", isGameActive);
      console.log("replay stage (updated):", replayStage);
      handleTimeUp();
      console.log("pass mark - 2 " + MIN_CORRECT_ANSWERS);
      console.log("score - 2 " + correctAnswers);
      setShowScore(true)
    }
