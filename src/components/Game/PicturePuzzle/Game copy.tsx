      ...
      <Overlay opened={showModal} >
        <GameScoreModal title='Your Result'>
          <div className='mt-2 py-12'>
            ...
            <div onClick={restartGame} className='flex mt-12 cursor-pointer justify-center items-center text-white bg-indigo-900 hover:bg-indigo-700 py-1 px-4 rounded '>
              Replay
            </div>
          </div>
        </GameScoreModal>
